# AHRI 1600
# functions: Additional Steps for Calculating the SHORE of a Heat Pump
#            Having a Single-Speed Compressor and a Variable-Speed, Variable-Air-Volume-Rate Indoor Blower
...
def get_delta_Full_cutout_factor(
    ...
    """
    # constant used in Appendix M, M1 : 3.413 will be changed to AHRI 1600 and Appendix M2 (tentative) 3.412
...
def get_E_tj(
    ...
    """
    get total energy (W) at each bin temperature
